...
try {
  ...
  foreach ($playlists as &$playlist) {
    ...
    $trackIds = explode(',', $playlist['track_ids']);
    ...
    foreach ($tracks as &$track) {
      ...
      $artists = $table->fetchAll($artistsQuery, ['track_id' => $track['id']]);
    ...
    $playlist['owner'] = [
      ...
      'role' => $playlist['user_role'],
      'created_at' => $playlist['user_created_at']
    ];

    $playlist['tracks'] = $tracks;

    unset($playlist['track_ids'], $playlist['user_id'], $playlist['user_name'], $playlist['user_email'], $playlist['user_role'], $playlist['user_created_at']);
  }
